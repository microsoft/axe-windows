...
namespace Axe.Windows.RulesTests.Library
{
    ...
    public class IsControlElementTrueRequiredTextInEditXAMLTests
    {
        ...
        private static readonly Rules.IRule Rule = new Rules.Library.IsControlElementTrueRequiredTextInEditXAML(excludedCondition: null);
        ...
        [TestMethod]
        public void Condition_ControlTypeIsXamlTextInEdit_ReturnsTrue()
        {
            _elementMock.Setup(m => m.BoundingRectangle).Returns(ValidRectangle);
